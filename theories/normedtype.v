...
Proof.
move=> Aa; apply: le_anti; apply/andP.
split; last exact: edist_inf_ge0.
...
- rewrite eqEsubset /f /f' /=; split => ? /=.
    by case=> z Az; rewrite edist_inf0 //= => <-; rewrite /minr epos mul0r.
